      ...
      body: SingleChildScrollView(
        child: Stack(
          children: [
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(width: 8), // Memberikan jarak antara ikon search dan menu
                        Container(
                          width: 40,
                          height: 40,
                          decoration: BoxDecoration(
            ...
            Padding(
              padding: const EdgeInsets.only(top: 212, left: 20), // Menyesuaikan jarak ke bawah teks
              child: Column(
            ...
            GestureDetector(
              onTap: () {
                _translateBio(context); // Panggil fungsi _translateBio ketika teks "Translate Bio" diklik
              },
              child: Padding(
                padding: const EdgeInsets.only(top: 370, left: 20, right: 20), // Sesuaikan posisi teks dengan bio
                child: Text(
                  'Translate Bio',
                  style: TextStyle(
                    fontSize: 15,
